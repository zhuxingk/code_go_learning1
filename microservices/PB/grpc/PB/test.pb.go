...
type Student1 struct {
	...
	Cn      ClassName `protobuf:"varint,4,opt,name=cn,proto3,enum=PB.ClassName" json:"cn,omitempty"`
}

func (x *Student1) Reset() {
	*x = Student1{}
...
func (x *Student1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Student1) ProtoMessage() {}

func (x *Student1) ProtoReflect() protoreflect.Message {
	mi := &file_test_proto_msgTypes[0]
...
// Deprecated: Use Student1.ProtoReflect.Descriptor instead.
func (*Student1) Descriptor() ([]byte, []int) {
	return file_test_proto_rawDescGZIP(), []int{0}
}

func (x *Student1) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Student1) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *Student1) GetCn() ClassName {
	if x != nil {
		return x.Cn
	}
...
type Students struct {
	...
	Person []*Student1 `protobuf:"bytes,1,rep,name=person,proto3" json:"person,omitempty"` // repeated 修饰，相当于Go中切片
...
func (x *Students) GetPerson() []*Student1 {
	if x != nil {
		return x.Person
	}
	return nil
...
var file_test_proto_rawDesc = []byte{
	...
	0x22, 0x69, 0x0a, 0x08, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x31, 0x12, 0x12, 0x0a, 0x04,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1d, 0x0a, 0x02,
	0x63, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x50, 0x42, 0x2e, 0x43, 0x6c,
	0x61, 0x73, 0x73, 0x4e, 0x61, 0x6d, 0x65, 0x52, 0x02, 0x63, 0x6e, 0x22, 0x48, 0x0a, 0x08, 0x53,
	0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x24, 0x0a, 0x06, 0x70, 0x65, 0x72, 0x73, 0x6f,
	0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x50, 0x42, 0x2e, 0x53, 0x74, 0x75,
	0x64, 0x65, 0x6e, 0x74, 0x31, 0x52, 0x06, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x16, 0x0a,
	...
	0x61, 0x73, 0x73, 0x33, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x50, 0x42, 0x62, 0x06,
...
var file_test_proto_goTypes = []interface{}{
	(ClassName)(0),   // 0: PB.ClassName
	(*Student1)(nil), // 1: PB.Student1
	(*Students)(nil), // 2: PB.Students
}
var file_test_proto_depIdxs = []int32{
	0, // 0: PB.Student1.cn:type_name -> PB.ClassName
	1, // 1: PB.Students.person:type_name -> PB.Student1
